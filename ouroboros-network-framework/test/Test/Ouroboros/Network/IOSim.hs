...
tests =
    ...
    [ testGroup "generators"
      ...
      , testProperty "generator NonFailingBearerInfoScript" prop_generator_NonFailingBeararInfoScript
      ]
...
newtype NonFailingBearerInfoScript = NonFailingBearerInfoScript (Script AbsBearerInfo)
  deriving       Show via (Script AbsBearerInfo)
  deriving stock Eq
